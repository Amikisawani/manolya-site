...
const pillars = [
  ...
  {
    title: "Accueil de proximité",
    body: "Une officine ouverte du lundi au dimanche, pensée pour les familles de Kinshasa.",
  },
];
...
export default function HomePage() {
  return (
    <>
      ...
      <section className="border-b border-mp-line">
